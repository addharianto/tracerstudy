...
class ArtikelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('alumni.artikel.index',compact('artikel'));
    }
    ...
    public function create()
    {
        ...
        return view('alumni.artikel.create',compact('kategoriArtikel'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('alumni.artikel.index')->with('success','Data berhasil ditambah');
    }
    ...
    {   
        ...
        return view('alumni.artikel.edit',compact('artikel','kategoriArtikel'));
    }
    ...
    public function update(Request $request, Artikel $artikel)
    {
        ...
        return redirect()->route('alumni.artikel.index')->with('success','Data berhasil diupdate');
    }
    ...
    {   
        ...
        $artikel->delete();
        return redirect()->route('alumni.artikel.index')->with('success','Data berhasil dihapus');
    }
}
