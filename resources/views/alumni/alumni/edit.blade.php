...
<div class="">    
    <div class="card">
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('alumni.alumni.update',$alumni->id) }}">
            @csrf
            @method('PATCH')
            <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input required="" type="" vlaue="{{$alumni->kode_pt}}" name="kode_pt"class="form-control"> 
                </div>
                     <div id="form-group">
