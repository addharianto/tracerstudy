...
<div class="">    
    <div class="card">
        <div class="card-header">
            <a href="{{ route('alumni.pengumuman.index') }}" class="btn btn-success btn-sm">Kembali</a>
        </div>
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('alumni.pengumuman.update',$pengumuman->id) }}">
            @csrf
            @method('PATCH')
