    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('alumni.artikel.create') }}" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>
            <div class="card-body table-responsive">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="row ml-2">
                        <a href="{{ route('alumni.artikel.edit',$art->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>
                        
                        <form method="POST" action="{{ route('alumni.artikel.destroy',$art->id) }}">
                            @csrf
                            @method('DELETE')
